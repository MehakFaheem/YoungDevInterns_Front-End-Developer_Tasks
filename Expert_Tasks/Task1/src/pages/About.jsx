      ...
      <div className="mb-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            { name: 'Michael Chen', role: 'Lead Developer', img: 'https://randomuser.me/api/portraits/men/75.jpg' },
            { name: 'Emily Davis', role: 'Product Designer', img: 'https://randomuser.me/api/portraits/women/68.jpg' },
          ].map((member, index) => (
